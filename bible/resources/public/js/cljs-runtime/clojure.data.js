...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__8514){
...
var vec__8522 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8522,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8522,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8522,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_8615 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_8615(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_8619 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_8619(a,b);
}
});
...
var fexpr__8587 = (function (){var G__8588 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__8588__$1)].join('')));

}
})();
return (fexpr__8587.cljs$core$IFn$_invoke$arity$2 ? fexpr__8587.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__8587.call(null,a,b));
}));
/**
