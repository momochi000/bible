...
var G__12198 = o;
reagent.impl.template.goog$module$goog$object.set(G__12198,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__12199 = o;
reagent.impl.template.goog$module$goog$object.set(G__12199,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__12200 = props;
var G__12200__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12200,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12200);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12200__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__12201 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12201,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__12201;
}
})(),id_class);
...
var G__12202 = (cljs.core.count(argv) - first_child);
switch (G__12202) {
case (0):
...
var vec__12203 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12203,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12203,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12203,(2),null);
...
var temp__5827__auto___12223 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___12223 == null)){
} else {
var key_12224 = temp__5827__auto___12223;
(jsprops.key = key_12224);
}
...
var temp__5827__auto___12225 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___12225 == null)){
} else {
var key_12226 = temp__5827__auto___12225;
(jsprops.key = key_12226);
}
...
var temp__5827__auto___12227 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___12227 == null)){
} else {
var key_12228 = temp__5827__auto___12227;
...
var temp__5827__auto___12229 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___12229 == null)){
} else {
var key_12230 = temp__5827__auto___12229;
(jsprops.key = key_12230);
}
...
var temp__5827__auto___12231 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___12231 == null)){
} else {
var key_12232 = temp__5827__auto___12231;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12206_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__12206_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__12207 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12207,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12207,(1),null);
...
*/
reagent.impl.template.t_reagent$impl$template12213 = (function (opts,id,fn_to_element,parse_fn,meta12214){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template12213.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12215,meta12214__$1){
var self__ = this;
var _12215__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template12213(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta12214__$1));
}));

(reagent.impl.template.t_reagent$impl$template12213.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12215){
var self__ = this;
var _12215__$1 = this;
return self__.meta12214;
}));

(reagent.impl.template.t_reagent$impl$template12213.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template12213.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template12213.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template12213.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template12213.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template12213.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta12214","meta12214",-1185814992,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template12213.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template12213.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template12213");

(reagent.impl.template.t_reagent$impl$template12213.cljs$lang$ctorPrWriter = (function (this__5310__auto__,writer__5311__auto__,opt__5312__auto__){
return cljs.core._write(writer__5311__auto__,"reagent.impl.template/t_reagent$impl$template12213");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template12213.
 */
reagent.impl.template.__GT_t_reagent$impl$template12213 = (function reagent$impl$template$__GT_t_reagent$impl$template12213(opts,id,fn_to_element,parse_fn,meta12214){
return (new reagent.impl.template.t_reagent$impl$template12213(opts,id,fn_to_element,parse_fn,meta12214));
});
...
return (new reagent.impl.template.t_reagent$impl$template12213(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
