...
var o10140 = temp__5821__auto__;
var temp__5821__auto____$1 = (o10140["core"]);
if(cljs.core.truth_(temp__5821__auto____$1)){
var o10141 = temp__5821__auto____$1;
return (o10141["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__8414__auto__ = f;
return (o__8414__auto__["toString"]).call(o__8414__auto__);
} else {
return "";
}
}catch (e10142){var _ = e10142;
return "";
}});
...
try{var o__8414__auto___10273 = t;
(o__8414__auto___10273["cljs$lang$ctorPrWriter"]).call(o__8414__auto___10273,t,writer);
}catch (e10143){var __10274 = e10143;
}
...
var char_code = (function (){var o__8414__auto__ = (new String(char$));
return (o__8414__auto__["charCodeAt"]).call(o__8414__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__8414__auto__ = String;
return (o__8414__auto__["fromCharCode"]).call(o__8414__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10148 = num_code;
switch (G__10148) {
case (1):
return (185);
...
var o__8414__auto__ = String;
return (o__8414__auto__["fromCharCode"]).call(o__8414__auto__,superscript_code);
});
/**
...
}catch (e10155){var _e__8421__auto__ = e10155;
return false;
}})())){
...
var vec__10156 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10156,(0),null);
...
var len__5749__auto___10276 = arguments.length;
var i__5750__auto___10277 = (0);
while(true){
if((i__5750__auto___10277 < len__5749__auto___10276)){
args__5755__auto__.push((arguments[i__5750__auto___10277]));

var G__10278 = (i__5750__auto___10277 + (1));
i__5750__auto___10277 = G__10278;
continue;
} else {
}
break;
...
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10162,(0),null);
...
var G__10279 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__10280 = cljs.core.butlast(remaining_tokens);
name_tokens = G__10279;
remaining_tokens = G__10280;
continue;
}
}
break;
...
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10160,seq10159__$1);
}));
...
var vec__10167 = cljs.core.split_with((function (p1__10166_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__10166_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10167,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10167,(1),null);
...
var vec__10176 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10176,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10176,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__10282 = cljs.core.rest(remaining_tokens);
var G__10283 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__10282;
name_tokens = G__10283;
continue;
} else {
...
var vec__10181 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10181,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10181,(1),null);
var vec__10184 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10184,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10184,(1),null);
var vec__10187 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10187,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10187,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10187,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10187,(3),null);
...
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10193,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10193,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10193,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10193,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10193,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10193,(5),null);
...
if(cljs.core.truth_(temp__5821__auto__)){
var vec__10197 = temp__5821__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10197,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10197,(1),null);
var vec__10200 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10200,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10200,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__10203 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__10203) : devtools.munging.parse_fn_info_deep.call(null,G__10203));
})()));
}
} else {
return fn_info;
...
var G__10286 = (arity + (1));
var G__10287 = (function (){var temp__5821__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5821__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10230){
var vec__10231 = p__10230;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10231,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10231,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10234_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__10234_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10235_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__10235_SHARP_);
}),sorted_infos);
...
var args__5755__auto__ = [];
var len__5749__auto___10288 = arguments.length;
var i__5750__auto___10289 = (0);
while(true){
if((i__5750__auto___10289 < len__5749__auto___10288)){
args__5755__auto__.push((arguments[i__5750__auto___10289]));

var G__10290 = (i__5750__auto___10289 + (1));
i__5750__auto___10289 = G__10290;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10238){
var vec__10239 = p__10238;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10239,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10236){
var G__10237 = cljs.core.first(seq10236);
var seq10236__$1 = cljs.core.next(seq10236);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10237,seq10236__$1);
}));
...
var map__10249 = options;
var map__10249__$1 = cljs.core.__destructure_map(map__10249);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10249__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10249__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10249__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10249__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10250 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10250,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10250,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10250,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10250,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10250,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10250,(5),null);
...
var o__8414__auto__ = f;
return (o__8414__auto__["getBasis"]).call(o__8414__auto__);
});
/**
...
}catch (e10253){var _e__8421__auto__ = e10253;
...
var G__10292 = (obj[cljs.core.first(path)]);
var G__10293 = cljs.core.rest(path);
obj = G__10292;
path = G__10293;
continue;
} else {
...
var _STAR_ = (function (accum,p__10256){
var vec__10257 = p__10256;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10257,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10257,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10260){
var vec__10261 = p__10260;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10261,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10261,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10261,(2),null);
...
var post_process = (function (p__10265){
var vec__10266 = p__10265;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10266,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10266,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10264_SHARP_){
return (obj[cljs.core.first(p1__10264_SHARP_)]);
}),sorted_matches);
