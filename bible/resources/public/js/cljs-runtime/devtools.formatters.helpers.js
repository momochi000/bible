...
var G__10582 = devtools.prefs.pref(v);
v = G__10582;
continue;
} else {
return v;
...
}catch (e10519){var _e__8421__auto__ = e10519;
return false;
}})();
...
}catch (e10524){var _e__8421__auto__ = e10524;
return false;
}})();
...
}catch (e10526){var _e__8421__auto__ = e10526;
return false;
}}
}
});
...
var vec__10574 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10574,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10574,(1),null);
...
return cljs.core.some((function (p1__10577_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10577_SHARP_);
}),template);
});
