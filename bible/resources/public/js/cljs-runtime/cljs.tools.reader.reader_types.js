...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_13330 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_13330(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_13331 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_13331(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13335 = (function (reader,ch){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13335(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13345 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13345(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13347 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13347(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13349 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13349(reader);
}
});
...
var G__13367 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__13368 = s.append(c);
c = G__13367;
s = G__13368;
continue;
}
