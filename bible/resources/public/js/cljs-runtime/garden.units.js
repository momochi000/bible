 ...
 */
garden.units.convert = (function garden$units$convert(p__13871,right){
var map__13872 = p__13871;
var map__13872__$1 = cljs.core.__destructure_map(map__13872);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13872__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13872__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__13873 = temp__5823__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13873,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13873,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13873,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13876__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__13877 = u(y);
var map__13877__$1 = cljs.core.__destructure_map(map__13877);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13877__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__13885__delegate = function (x,y,more){
...
while (G__13886__i < G__13886__a.length) {G__13886__a[G__13886__i] = arguments[G__13886__i + 2]; ++G__13886__i;}
  more = new cljs.core.IndexedSeq(G__13886__a,0,null);
} 
...
var y = cljs.core.first(arglist__13887);
var more = cljs.core.rest(arglist__13887);
...
G__13888 = new cljs.core.IndexedSeq(G__13889__a,0,null);
}
return garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13888);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13878__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__13879 = u(y);
var map__13879__$1 = cljs.core.__destructure_map(map__13879);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13879__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__13890__delegate = function (x,y,more){
...
while (G__13891__i < G__13891__a.length) {G__13891__a[G__13891__i] = arguments[G__13891__i + 2]; ++G__13891__i;}
  more = new cljs.core.IndexedSeq(G__13891__a,0,null);
} 
...
var y = cljs.core.first(arglist__13892);
var more = cljs.core.rest(arglist__13892);
...
G__13893 = new cljs.core.IndexedSeq(G__13894__a,0,null);
}
return garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13893);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13880__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__13881 = u(y);
var map__13881__$1 = cljs.core.__destructure_map(map__13881);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13881__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
while (G__13896__i < G__13896__a.length) {G__13896__a[G__13896__i] = arguments[G__13896__i + 2]; ++G__13896__i;}
  more = new cljs.core.IndexedSeq(G__13896__a,0,null);
} 
...
G__13898 = new cljs.core.IndexedSeq(G__13899__a,0,null);
}
return garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13898);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13882__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__13883 = u(y);
var map__13883__$1 = cljs.core.__destructure_map(map__13883);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13883__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
...
return garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13903);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
